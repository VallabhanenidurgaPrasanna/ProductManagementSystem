...
body {
	background-image:
		url("https://t4.ftcdn.net/jpg/04/23/35/19/360_F_423351962_SgDFnFAbvDpuBQrGiIwhJVIBS4hIiDw0.jpg");
}
...
<body>
	<ul>
		...
		<li><a href="/ProductManagementSystem/getAll">GetAllProducts</a></li>
		<li><a href="/ProductManagementSystem/getbyid">GetById</a></li>
